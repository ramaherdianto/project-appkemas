			...
			<div class="container d-flex align-items-center">
				...
				<nav class="nav-menu d-none d-lg-block">
					<ul>
						...
						<li><a class="nav-link scrollto" href="#ba-home">Buat Acara</a></li>
			...
			<div id="welcomeCarousel" class="container carousel carousel-fade" data-ride="carousel">
				<div class="carousel-item active">
					...
					<div class="carousel-footer text-center">
						<a href="<?php echo base_url('appkemas/buat_event') ?>" class="btn-get-started animate__animated animate__fadeInUp scrollto">
							Buat Acara&ensp;<i class="icofont-calendar"></i>
						</a>
                        <a href="<?php echo base_url('appkemas/lihat_event') ?>" class="btn-get-started animate__animated animate__fadeInUp scrollto">
				...
				<div class="container">
					<div class="row" data-aos="zoom-in">
						<div class="col-lg-9 text-center text-lg-left">
							<h3>Buatlah Acaramu !</h3>
							<p>
								Ayoo buatlah acaramu sendiri dan sampaikan lah acaramu ke semua penduduk dikomplek dengan penyajian yang menarik dan efektif.
							</p>
						</div>
						<div class="col-lg-3 ba-home-btn-container text-center">
							<a class="ba-home-btn align-middle" href="<?php echo base_url('appkemas/buat_event')?>">Buat Acara</a>
						</div>
					</div>
				</div>
			</section>
				...
				<div class="container" data-aos="fade-up">
					...
					<div class="table-responsive">
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<?php
								$no=1;
								foreach($tbpesan as $tbp) { ?>
								<tbody>
									<tr>
										<td><?php echo $no++ ?></td>
										<td><?php echo $tbp->subjek ?></td>
										<td><?php echo $tbp->nama ?></td>
										<td><?php echo $tbp->email ?></td>
										<td>
											<?php echo anchor('appkemas/detail_pesan/'. $tbp->id, '<div class="btn btn-success btn-sm"><i class="icofont-clip" style="color:white;"> detail</i></div>') ?>
										</td>
										<td onclick="javascript: return confirm('Yakin dihapus?')">
											<?php echo anchor('appkemas/hapus_pesan/'.$tbp->id, '<div class="btn btn-danger btn-sm"><i class="icofont-ui-delete"> hapus</i></div>') ?>
										</td>
									</tr>
								</tbody>
								<?php } ?>
