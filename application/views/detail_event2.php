	...
	<header id="header-tampil" class="header fixed-top">
		...
		<main id="main">
            ...
            <section class="detail-event" data-aos="zoom-in-up">
                <div class="container">
                    ...
                    <div class="text-center btn-print">
						<a class="btn btn-secondary" href="<?php echo site_url('appkemas/lihat_eventuser') ?>"><i class="icofont-print">&ensp;Print Detail Acara</i></a>
					</div><br><br>
            ...
            <div class="text-center" style="margin-top:10rem;" data-aos="zoom-in">
                <a class="btn btn-primary" href="<?php echo base_url('appkemas/lihat_eventuser') ?>"><i class="icofont-arrow-left">&ensp;Kembali</i></a>
            </div>
