...
<li class="nav-item">
    <a class="nav-link" href="<?= base_url('appkemas/buat_event'); ?>">
        <i class="fas fa-fw fa-calendar-plus"></i>
        <span>Buat Acara</span></a>
</li>

<hr class="sidebar-divider">

<li class="nav-item">
    <a class="nav-link" href="<?= base_url('appkemas/lihat_event'); ?>">
			...
			<div id="welcomeuserCarousel" class="container carousel carousel-fade" data-ride="carousel">
				<div class="carousel-item active">
					...
					<div class="carousel-footer text-center">
                        <a href="<?php echo base_url('appkemas/admin') ?>" class="btn-get-started animate__animated animate__fadeInUp scrollto">
